        ...
        <el-row class="article_box">
            ...
            <el-col :xs="24" :sm="18" :md="16">
                ...
                <el-card v-else class="md-preview">
                    <MdPreview class="md-preview-v3" v-model="mdState.text" :editorId="mdState.id"
                        :preview-theme="previewTheme" :code-theme="codeTheme" :theme="mainTheme ? 'dark' : 'light'">
                    </MdPreview>
                    ...
                    <div class="recommend flex_r_between">
                        <div class="recommend-box" @click="goToArticle(previousArticle)">
                            ...
                            <span class="recommend-box-item prev">
                                ...
                                <Tooltip width="60%" color="#fff" :weight="600" :name="previousArticle.article_title"
                                    align="left"></Tooltip>
                            </span>
                        </div>
                        <div class="recommend-box" @click="goToArticle(nextArticle)">
                            ...
                            <span class="recommend-box-item next">
                                ...
                                <Tooltip width="60%" color="#fff" :weight="600" :name="nextArticle.article_title"
                                    align="right"></Tooltip>
                            </span>
                        </div>
                    </div>
                        ...
                        <el-row style="padding: 2rem">
                            ...
                            <el-col :span="12" v-for="item in recommendList" :key="item.id" @click="goToArticle(item)">
                                <el-card class="card card-hover">
                                    ...
                                    <el-image class="image animate__animated animate__fadeInDown" fit="cover"
                ...
                <el-card v-else class="command card-hover" header="推荐文章">
                    <div class="command-box">
                        <div class="command-box-item" v-for="(item, index) in recommendList" :key="index"
                            ...
                            <el-image class="command-box-item__img animate__animated animate__fadeInDown" fit="cover"
                                width="50" :src="item.article_cover">
                                <template #error>
