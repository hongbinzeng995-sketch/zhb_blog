...
const avatar = ref(blogAvatar); // 博客头像 default
...
<template>
  <div class="info-background" v-image="configDetail.avatar_bg">
    <el-image fit="cover" style="width: 100%; height: 100%" :src="configDetail.avatar_bg" preview-teleported
  ...
  <div class="git-ee flex_r_around">
    <span class="git-ee__item button-animated" @click="operate('openLink', configDetail.git_ee_link)">
      ...
      <span class="git-ee__item-text">Z-Gitee</span>
    </span>
  </div>
